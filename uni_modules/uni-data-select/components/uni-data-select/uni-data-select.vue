		...
		<view class="uni-stat-box" :class="{'uni-stat__actived': current}">
			<view class="uni-select" :class="{'uni-select--disabled':disabled}">
				<view class="uni-select__input-box" @click="toggleSelector">
					...
					<view v-if="current && clear && !disabled" key="clear-button" @click.stop="clearVal">
						<uni-icons type="clear" color="#c0c4cc" size="24" />
					</view>
					<view v-else key="arrow-button">
						<uni-icons :type="showSelector? 'top' : 'bottom'" size="14" color="#999" />
					</view>
				</view>
				<view v-if="showSelector" class="uni-select--mask" @click="toggleSelector" />
				<view v-if="showSelector" class="uni-select__selector" :style="getOffsetByPlacement">
