...
const types = {
	...
	email(value) {
		return typeof value === 'string' && Boolean(value.match(pattern.email)) && value.length < 255;
	},
	url(value) {
		return typeof value === 'string' && Boolean(value.match(pattern.url));
	},
	pattern(reg, value) {
		try {
	...
	idcard(value) {
		return typeof value === 'string' && Boolean(value.match(pattern.idcard));
	},
	'url-https'(value) {
