<template>
	<view class="uni-data-tree">
			...
			<slot :options="options" :data="inputSelected" :error="errorMessage">
				<view class="input-value" :class="{'input-value-border': border}">
					...
					<view v-else-if="loading && !isOpened" class="selected-area">
						<uni-load-more class="load-more" :content-text="loadMore" status="loading" />
					</view>
		...
		<view v-if="isOpened" class="uni-data-tree-cover" @click="handleClose" />
		<view v-if="isOpened" class="uni-data-tree-dialog">
			...
			<view class="dialog-caption">
				...
				<view class="dialog-close" @click="handleClose">
					<view class="dialog-close-plus" data-id="close" />
					<view class="dialog-close-plus dialog-close-rotate" data-id="close" />
				</view>
			</view>
			<data-picker-view
				ref="pickerView"
